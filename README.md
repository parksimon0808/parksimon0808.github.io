# FILES TO UPDATE
0. _config.yml
1. landing page: _pages/about.md
2. reseach project: _posts/*, research/index.html, assets/pdf/*
3. teaching experience: _pages/teaching.md
4. cv: _data/cv.yml, assets/pdf/*
